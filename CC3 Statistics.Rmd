...
### 1.3 Reading data into the R environment
...
### 1.4 Storing data as R variables 
Using read functions to read in data is not enough. You'll need a <strong>variable</strong> to store your data. To assign data to a variable, use `<-` to do so. See the following example: 
``` {r class.source = "code1", eval = FALSE}
...
From this output table, we can see that the function gives us several output
# 3. Inferential statistics
Some other inferential statistics function in R that you might find useful

| Function    | Purpose     |Syntax       |Package | documentation |
| :---------: | :---------: | :---------: |:----:  |:---------: |
| Header      | Title       | Title       |base    |[Click me](https://www.google.com)       |
| Paragraph   | Text        | Title       |base    |Title       |


# 4. Ending remarks and a brief cheatsheet
In this notebook, we've introduced a lot 
