...
The distribution of the data looks like a bell-shaped curve, but tilting (skewed) towards the right. Thus, we say that this data is not normally distributed. 

## 3.2 Choosing a statistical test

After determining the normality of the data, we could start our inferential statistical analysis. Below is a flow chart helping you decide which statistical tests to use in different circumstances. However, <strong> please note that this is not the definitive guide to determining the type of statistical tests you can use. The choice of statistical tests should be informed by further research.</strong>
