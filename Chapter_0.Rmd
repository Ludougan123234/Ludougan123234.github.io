---
title: "Chapter 0: Getting things started"
output:
  html_document:
    css: style.css
---
...
<li> <b>Write your code in a script</b>: Although R allows you to write and execute code directly in the console, the code you type in the console will not be saved. This means that your code and execution results will be cleared if you do not save your code in a script. So, you should always write your code in a script and execute them using `cmd+enter` on mac or `ctrl + enter` on windows computers. 
</ul>

### 0.3 Some terminologies in R: 
<ul>
<li><b>String:</b> A sequence of characters or numbers enclosed with double quotation marks
<li><b>Data-frame:</b> A table-like or two dimensional array with data stored in it.
</ul>
